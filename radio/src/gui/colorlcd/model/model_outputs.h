...
class ModelOutputsPage : public PageGroupItem
{
 public:
  ...
  static constexpr coord_t EXLIMCB_Y = PAD_SMALL;
  static constexpr coord_t EXLIM_X = PAD_SMALL;
  static constexpr coord_t EXLIM_Y = PAD_LARGE + PAD_TINY;
  ...
  static constexpr coord_t OUTPUTS_X = PAD_SMALL;
  static constexpr coord_t OUTPUTS_Y = EXLIMCB_Y + EXLIMCB_H + PAD_MEDIUM / 2;
  static constexpr coord_t OUTPUTS_W = LCD_W - PAD_SMALL * 2;
