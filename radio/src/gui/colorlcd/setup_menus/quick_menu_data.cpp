...
const PageDef modelMenuItems[] = {
  ...
  { ICON_MODEL_MIXER, STR_DEF(STR_CHANNEL_MAPPING), STR_DEF(STR_CHANNEL_MAPPING), PAGE_CREATE, QM_MODEL_CHANNEL_MAPPING, [](const PageDef& pageDef) { return new ModelChannelMappingsPage(pageDef); }},
