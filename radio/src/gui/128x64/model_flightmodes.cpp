...
#if MAX_GVARS > 9
  ITEM_MODEL_FLIGHT_MODE_GV10,
  ITEM_MODEL_FLIGHT_MODE_GV11,
  ITEM_MODEL_FLIGHT_MODE_GV12,
  ITEM_MODEL_FLIGHT_MODE_GV13,
  ITEM_MODEL_FLIGHT_MODE_GV14,
  ITEM_MODEL_FLIGHT_MODE_GV15,
#endif
#endif
