...
enum {
  CASE_RTCLOCK(ITEM_RADIO_SETUP_DATE) CASE_RTCLOCK(ITEM_RADIO_SETUP_TIME) CASE_AUDIO(
      ITEM_RADIO_SETUP_SOUND_LABEL) CASE_AUDIO(ITEM_RADIO_SETUP_BEEP_MODE)
      CASE_AUDIO(ITEM_RADIO_SETUP_SPEAKER_VOLUME) CASE_AUDIO(
                  ...
                  ITEM_RADIO_SETUP_VOLUME_SOURCE)
                      ...
                      CASE_VARIO(ITEM_RADIO_SETUP_VARIO_LABEL) CASE_VARIO(
                          ...
                          CASE_VARIO(ITEM_RADIO_SETUP_VARIO_PITCH) CASE_VARIO(
                              ITEM_RADIO_SETUP_VARIO_RANGE)
                              CASE_VARIO(ITEM_RADIO_SETUP_VARIO_REPEAT) CASE_HAPTIC(
                                  ITEM_RADIO_SETUP_HAPTIC_LABEL)
                                  CASE_HAPTIC(ITEM_RADIO_SETUP_HAPTIC_MODE) CASE_HAPTIC(
                                      ITEM_RADIO_SETUP_HAPTIC_LENGTH)
                                      CASE_HAPTIC(
                                          ITEM_RADIO_SETUP_HAPTIC_STRENGTH)
                                          CASE_IMU(ITEM_RADIO_SETUP_IMU_LABEL)
                                              CASE_IMU(ITEM_RADIO_SETUP_IMU_MAX)
                                                  CASE_IMU(
                                                      ITEM_RADIO_SETUP_IMU_OFFSET)
  ...
  MENU(
      STR_RADIO_SETUP, menuTabGeneral, MENU_RADIO_SETUP, ITEM_RADIO_SETUP_MAX,
      {
          ...
          CASE_VARIO(LABEL(VARIO)) CASE_VARIO(0) CASE_VARIO(0) CASE_VARIO(0)
              CASE_VARIO(0)
          // Haptic
          CASE_HAPTIC(LABEL(VARIO)) CASE_HAPTIC(0) CASE_HAPTIC(0) CASE_HAPTIC(0)
          // IMU
          CASE_IMU(LABEL(IMU)) CASE_IMU(0) CASE_IMU(0)
          // Alarms
          0,
          ALARMS_ROW(0),
          ALARMS_ROW(0),
