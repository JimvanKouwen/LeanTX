...
enum MenuRadioSetupItems {
  CASE_RTCLOCK(ITEM_RADIO_SETUP_DATE) CASE_RTCLOCK(ITEM_RADIO_SETUP_TIME)
  ...
  ITEM_RADIO_SETUP_VOLUME_SOURCE_OVRRIDE,
...
void menuRadioSetup(event_t event)
{
  ...
  MENU(
      STR_RADIO_SETUP, menuTabGeneral, MENU_RADIO_SETUP, ITEM_RADIO_SETUP_MAX,
      {
          ...
          SOUND_WARNING_ROW(LABEL(0)),  // volume control override warning
          ...
          0,                           // backlight control
          BACKLIGHT_WARNING_ROW(
              LABEL(0)),  // backlight control override warning
          0,              // flash beep
          0,
     ...
     case ITEM_RADIO_SETUP_BATTERY_CALIB:
      ...
      case ITEM_MODEL_QUICK_SELECT:
        ...
        g_eeGeneral.modelQuickSelect =
            editCheckBox(g_eeGeneral.modelQuickSelect, RADIO_SETUP_2ND_COLUMN, y,
                          nullptr, attr, event);
        break;
