...
enum USBJoystickIfMode {
  ...
  USBJOYS_GAMEPAD,
  USBJOYS_MULTIAXIS,
  USBJOYS_LAST = USBJOYS_MULTIAXIS
};
...
enum USBJoystickCh {
  ...
  USBJOYS_CH_AXIS,
  USBJOYS_CH_SIM,
  USBJOYS_CH_LAST = USBJOYS_CH_SIM
};
...
enum USBJoystickBtnMode {
  ...
  USBJOYS_BTN_MODE_LAST = USBJOYS_BTN_MODE_COMPANION
};
...
enum USBJoystickAxis {
  ...
  USBJOYS_AXIS_DIAL,
  USBJOYS_AXIS_WHEEL,
  USBJOYS_AXIS_LAST = USBJOYS_AXIS_WHEEL
};
...
enum USBJoystickSim {
  ...
  USBJOYS_SIM_HAT,
  USBJOYS_SIM_LAST = USBJOYS_SIM_HAT
};
...
enum USBJoystickCC {
  ...
  USBJOYS_CC_XYrXrY,
  USBJOYS_CC_XYZrZ,
  USBJOYS_CC_LAST = USBJOYS_CC_XYZrZ
};
