...
int main()
{
  ...
  std::vector<struct cfn> list = {
    ...
    { TR_BRIGHTNESS, "FUNC_BACKLIGHT", FUNC_BACKLIGHT, "OLED_SCREEN" },
    { TR_SF_BACKLIGHT, "FUNC_BACKLIGHT", FUNC_BACKLIGHT, "!OLED_SCREEN" },
    ...
    { TR_SF_DISABLE_KEYS, "FUNC_DISABLE_KEYS", FUNC_DISABLE_KEYS, "" },
