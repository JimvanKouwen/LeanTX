local function run(event)
  ...
  mixt= {name = "Mix1", source = 1, weight = 50, offset = 10, curveType = 1, curveValue = 50, flightModes = 3, delayUp = 5, speedDown = 5, speedUp =  2, delayDown = 5, mixWarn = 1 , multiplex = 1, switch = 3}
